...
本州・北海道・四国・九州・沖縄本島を除く有人島432島です。人口は令和2年国勢調査、面積は km² で、分からない島は「-」と表示します。令和2年国勢調査で住民が0人だった島は「0人※」と表示し、※にマウスを重ねると、それより前の国勢調査や住民基本台帳で住民が記録されていたことを島ごとに表示します（`scripts/census_zero_notes.json`）。
